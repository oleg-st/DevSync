...
namespace DevSyncTest.Command
{
    public class PacketTest
    {
        ...
        public void TestInit()
        {
            ...
            { AgentOptions = new AgentOptions { DestPath = "path", ExcludeList = new List<string> { "*.txt" } } });
        ...
        public void TestScan()
        {
            ...
            TestPacket(new ScanResponse(LoggerHelper.DummyLogger) { FileList = new List<FsEntry> { new FsEntry { Path = "path", LastWriteTime = DateTime.Now, Length = 1024 } } });
        }

        private void TestPacket(Packet packet)
        {
