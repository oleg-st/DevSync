...
public class SshRsaKeyGenerator(int keySize = 2048)
{
    private readonly RSACryptoServiceProvider _rsaCryptoServiceProvider = new(keySize);
    ...
    public string ToRfcPublicKey(string comment)
    {
        ...
        ms.Write([0], 0, 1); //Add a 0 to Emulate PuttyGen
