...
public class FsChangeResult : IEquatable<FsChangeResult>
{
    ...
    public static readonly FsChangeResult Empty = new() { ChangeType = FsChangeType.EmptyMarker };

    public bool Equals(FsChangeResult? other) => 
        other != null && ChangeType == other.ChangeType && Path == other.Path && ResultCode == other.ResultCode && ErrorMessage == other.ErrorMessage;
}